      ...
      <div className="relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="relative group">
            <label htmlFor="name" className="block text-white text-sm mb-2 transition-all duration-300 group-focus-within:text-blue-400">
              Name
            </label>
          ...
          <div className="relative group">
            <label htmlFor="confirmPassword" className="block text-white text-sm mb-2 transition-all duration-300 group-focus-within:text-blue-400">
              Confirm Password
            </label>
            <div className="relative">
              <input
